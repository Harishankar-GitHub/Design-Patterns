...
//     Bridge Pattern : Bridge pattern is also a structural pattern.
...
//     which has Rectangle and Triangle. And each shape has two color variants red and yellow, so you extended and created RedRectangleShape and YellowRectangleShape and the same for triangle.
